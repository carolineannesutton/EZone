...
ggplot(Northern, aes(x = Lgt_cm, fill = Sex)) +
  geom_histogram(binwidth = 1) +   # adjust binwidth as needed
  #scale_x_continuous(breaks = seq(0,65,10),limits = c(0,65))+
  xlab("Northern Zone SL length (cm)") +
  ylab("Count") +
...
ggplot(Central, aes(x = Lgt_cm, fill = Sex)) +
  geom_histogram(binwidth = 1) +   # adjust binwidth as needed
  #scale_x_continuous(breaks = seq(0,65,10),limits = c(0,65))+
  xlab("Central Zone SL length (cm)") +
  ylab("Count") +
  facet_wrap(~MonthName)+
   theme_minimal()
```
...
ggplot(Southern, aes(x = Lgt_cm, fill = Sex)) +
  geom_histogram(binwidth = 1) +   # adjust binwidth as needed
  #scale_x_continuous(breaks = seq(0,65,10),limits = c(0,65))+
  xlab("Southern Zone SL length (cm)") +
  ylab("Count") +
  facet_wrap(~MonthName)+
   theme_minimal()
```
...
ggplot(unknown, aes(x = Lgt_cm, fill = Sex)) +
  geom_histogram(binwidth = 1) +   # adjust binwidth as needed
  #scale_x_continuous(breaks = seq(0,65,10),limits = c(0,65))+
  xlab("unknown Zone SL length (cm)") +
  ylab("Count") +
  facet_wrap(~MonthName)+
   theme_minimal()
```
